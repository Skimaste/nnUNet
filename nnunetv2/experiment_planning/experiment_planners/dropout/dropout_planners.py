...
class ResEncDropoutUNetPlanner(ExperimentPlanner):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 32,
                 preprocessor_name: str = 'DefaultPreprocessor', plans_name: str = 'nnUNetResEncDropoutUNetPlans',
    ...
    def get_plans_for_configuration(self,
        ...
        architecture_kwargs = {
            ...
            'arch_kwargs': {
                ...
                'skip_dropout_layers': self.skip_dropout_layers,
            },
...
class p02_s2_planner(ResEncDropoutUNetPlanner):
    """
    Target is ~9-11 GB VRAM max -> older Titan, RTX 2080ti
    """
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 32,
                 preprocessor_name: str = 'DefaultPreprocessor', plans_name: str = 'p02_s2',
                 overwrite_target_spacing: Union[List[float], Tuple[float, ...]] = None,
                 suppress_transpose: bool = False):
...
class p02_s3_planner(ResEncDropoutUNetPlanner):
    """
    Target is ~9-11 GB VRAM max -> older Titan, RTX 2080ti
    """
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 32,
                 preprocessor_name: str = 'DefaultPreprocessor', plans_name: str = 'p02_s3',
                 overwrite_target_spacing: Union[List[float], Tuple[float, ...]] = None,
                 suppress_transpose: bool = False):
        if gpu_memory_target_in_gb != 32:
            warnings.warn("WARNING: You are running nnUNetPlannerM with a non-standard gpu_memory_target_in_gb. "
        ...
        # parameters regarding dropout
        self.dropout_p = 0.2
        self.skip_dropout_layers = 3

class p02_s1_planner(ResEncDropoutUNetPlanner):
    """
    Target is ~9-11 GB VRAM max -> older Titan, RTX 2080ti
    """
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 32,
                 preprocessor_name: str = 'DefaultPreprocessor', plans_name: str = 'p02_s1',
                 overwrite_target_spacing: Union[List[float], Tuple[float, ...]] = None,
                 suppress_transpose: bool = False):
        if gpu_memory_target_in_gb != 32:
            warnings.warn("WARNING: You are running nnUNetPlannerM with a non-standard gpu_memory_target_in_gb. "
        ...
        # parameters regarding dropout
        self.dropout_p = 0.2
        self.skip_dropout_layers = 1

class p01_s2_planner(ResEncDropoutUNetPlanner):
    """
    Target is ~9-11 GB VRAM max -> older Titan, RTX 2080ti
    """
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 32,
                 preprocessor_name: str = 'DefaultPreprocessor', plans_name: str = 'p01_s2',
                 overwrite_target_spacing: Union[List[float], Tuple[float, ...]] = None,
                 suppress_transpose: bool = False):
        if gpu_memory_target_in_gb != 32:
            warnings.warn("WARNING: You are running nnUNetPlannerM with a non-standard gpu_memory_target_in_gb. "
...
class p05_s2_planner(ResEncDropoutUNetPlanner):
    """
    Target is ~9-11 GB VRAM max -> older Titan, RTX 2080ti
    """
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 32,
                 preprocessor_name: str = 'DefaultPreprocessor', plans_name: str = 'p05_s2',
                 overwrite_target_spacing: Union[List[float], Tuple[float, ...]] = None,
                 suppress_transpose: bool = False):
        if gpu_memory_target_in_gb != 32:
            warnings.warn("WARNING: You are running nnUNetPlannerM with a non-standard gpu_memory_target_in_gb. "
