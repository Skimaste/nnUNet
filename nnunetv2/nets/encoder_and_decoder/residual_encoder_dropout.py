...
class ResidualEncoderDropout(nn.Module):
    def __init__(self,
                 input_channels: int,
                 n_stages: int,
        ...
        for s in range(n_stages):
            ...
            if skip_dropout_layers is not None and s < skip_dropout_layers:
                stage = StackedResidualBlocks(
                    ...
                    conv_bias, norm_op, norm_op_kwargs, None, None, nonlin, nonlin_kwargs,
