...
class nnUNetPredictorMCDropout(object):
    def __init__(self,
    ...
    def initialize_from_trained_model_folder(self, model_training_output_dir: str,
        ...
        if use_folds is None:
            use_folds = nnUNetPredictorMCDropout.auto_detect_available_folds(model_training_output_dir, checkpoint_name)
    ...
    def manual_initialization(self, network: nn.Module, plans_manager: PlansManager,
        ...
        """
        This is used by the nnUNetTrainer to initialize nnUNetPredictorMCDropout for the final validation
        """
        self.plans_manager = plans_manager
        self.configuration_manager = configuration_manager
        self.list_of_parameters = parameters
...
def predict_entry_point_modelfolder():
    ...
    predictor = nnUNetPredictorMCDropout(tile_step_size=args.step_size,
                                use_gaussian=True,
